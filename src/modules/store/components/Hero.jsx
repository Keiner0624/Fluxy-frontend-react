// src/modules/store/components/Hero.jsx
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
              {[
                { icon: '⚡', label: t.quickResponse },
                { icon: '🔒', label: t.securePurchase },
                { icon: '✅', label: t.verifiedBusiness },
              ].map(s => (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {[
                  company?.address && { icon: '📍', label: t.location, text: company.address },
                  company?.phone   && { icon: '📞', label: t.phone,  text: company.phone },
                  { icon: '🕐', label: t.attention,  text: t.immediateResponse },
                  { icon: '🔒', label: t.security, text: t.securePurchase100 },
