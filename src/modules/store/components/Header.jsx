// src/modules/store/components/Header.jsx
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {phone && company?.plan !== 'FREE' && (
            <a href={`https://wa.me/${phone}?text=${waMsg}`} target="_blank" rel="noreferrer"
              ...
              style={{
                ...
                borderRadius: 12, padding: '8px 16px', fontSize: 13, fontWeight: 600, color: '#25d366',
              }}>
          ...
          <button onClick={onCartOpen} style={{
            ...
            borderRadius: 12, padding: '9px 14px', color: 'white', fontSize: 13, fontWeight: 600,
            ...
            {cartCount > 0 && (
              <span style={{
                background: 'var(--primary, #7c83fd)', color: 'white',
