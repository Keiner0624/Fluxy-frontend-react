    ...
    <div style={{
      ...
      <div className="hide-mobile" style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 340 }}>
          <BrandLogo size={64} showWordmark={false} style={{ justifyContent: 'center' }}
            imageStyle={{ margin: '0 auto 24px', boxShadow: '0 8px 32px rgba(124,131,253,0.35)', animation: 'float 6s ease infinite' }}
          />
          <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 32, fontWeight: 700, color: 'white', marginBottom: 12, letterSpacing: '-0.5px' }}>
            Gestiona tu tienda
          </h2>
          <p style={{ fontSize: 15, color: 'var(--text-soft)', lineHeight: 1.7, marginBottom: 40 }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <Link to="/" style={{
            ...
            fontSize: 13, color: 'var(--text-muted)', marginBottom: 32, transition: 'color 0.2s',
          }}
          ...
          <div style={{ marginBottom: 32 }}>
            <h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 30, fontWeight: 700, color: 'white', marginBottom: 8, letterSpacing: '-0.5px' }}>
              Bienvenido de nuevo
            </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Link to="/register-business" style={{
              ...
              color: 'var(--primary)', fontSize: 14, fontWeight: 600, transition: 'all 0.2s',
            }}
